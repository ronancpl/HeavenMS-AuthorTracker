...
javax.script.ScriptException: <eval>:155:44 Expected an operand but found )
        Array.prototype.push.apply(scrolls, );
                                            ^ in <eval> at line number 155 at column number 44
	...
	at jdk.nashorn.internal.scripts.Script$Recompilation$2957$966$\^eval\_.start(<eval>:29)
...
Caused by: jdk.nashorn.internal.runtime.ParserException: <eval>:155:44 Expected an operand but found )
        Array.prototype.push.apply(scrolls, );
                                            ^
...
scripts/npc/scroll_generator.js
javax.script.ScriptException: <eval>:156:44 Expected an operand but found )
        Array.prototype.push.apply(scrolls, );
                                            ^ in <eval> at line number 156 at column number 44
	at jdk.nashorn.api.scripting.NashornScriptEngine.throwAsScriptException(NashornScriptEngine.java:467)
	at jdk.nashorn.api.scripting.NashornScriptEngine.compileImpl(NashornScriptEngine.java:534)
	at jdk.nashorn.api.scripting.NashornScriptEngine.compileImpl(NashornScriptEngine.java:521)
	at jdk.nashorn.api.scripting.NashornScriptEngine.evalImpl(NashornScriptEngine.java:399)
	...
	at scripting.npc.NPCScriptManager.start(NPCScriptManager.java:75)
	at scripting.AbstractPlayerInteraction.openNpc(AbstractPlayerInteraction.java:378)
	at jdk.nashorn.internal.scripts.Script$Recompilation$2966$966$\^eval\_.start(<eval>:29)
	at jdk.nashorn.internal.runtime.ScriptFunctionData.invoke(ScriptFunctionData.java:637)
	at jdk.nashorn.internal.runtime.ScriptFunction.invoke(ScriptFunction.java:494)
	at jdk.nashorn.internal.runtime.ScriptRuntime.apply(ScriptRuntime.java:393)
	at jdk.nashorn.api.scripting.ScriptObjectMirror.callMember(ScriptObjectMirror.java:199)
	...
	at java.util.concurrent.ThreadPoolExecutor$Worker.run(Unknown Source)
	at java.lang.Thread.run(Unknown Source)
Caused by: jdk.nashorn.internal.runtime.ParserException: <eval>:156:44 Expected an operand but found )
        Array.prototype.push.apply(scrolls, );
                                            ^
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:292)
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:277)
